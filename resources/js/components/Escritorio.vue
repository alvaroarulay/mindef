...
export default {
  ...
  async mounted() {
    this.listar();
    const totales = await axios.get('http://181.188.171.199:8000/escritorio/grafica1');
    ...
    const auxiliares = await axios.get('http://181.188.171.199:8000/escritorio/grafica2');
