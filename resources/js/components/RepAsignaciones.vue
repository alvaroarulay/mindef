  ...
  methods: {
    ...
    registrarAsignacion(){
      if(this.cod_resp == 0){
        ...
        let me = this;
        window.open('http://181.188.171.199:8000/actual/repAsignaciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp +  '','_blank');
      }
    },
    registrarDevolucion(){
      if(this.cod_resp == 0){
        ...
        let me = this;
        window.open('http://181.188.171.199:8000/actual/repDevoluciones?codofic=' + me.cod_ofi + '&codresp='+ me.cod_resp +  '','_blank');
      }
    }
  },
